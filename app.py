...
@app.get("/api/count/${countString}")
def count(countString: str):
    print("count")
    text_length = len(countString)
    return {"countString": text_length}
